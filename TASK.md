...
- *2026-02-05 17:11* — DP-OPS-0026: Refactored PoT terminology, replaced the ops index with an Ops Kernel README, removed redundant security docs, and hardened truth and style lints. Verification: RUN (open, dump, context, truth, style, skill harvest, prune, llms). Blockers: none. NEXT: operator review for merge.
