...
- Operator (Human): Owns final decisions, approvals, secrets, release authority, and veto authority.
- Integrator (Lead AI): Maintains governance, structural integrity, and auditing. Generates Dispatch Packets, detects system drift, and performs commits, pushes, pull-request creation, gate monitoring, merges, and branch cleanup after applicable review gates pass and the Operator authorizes release.
