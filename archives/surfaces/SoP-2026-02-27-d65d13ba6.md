...
Objective summary:
Added `ops/src/surfaces/decision.md.tpl` as the canonical decision leaf template and
implemented `ops/bin/decision` with deterministic `DEC-YYYY-MM-DD-NNN` naming,
...
`archives/decisions/DEC-2026-02-27-001-decision-helper-0130.md` as the seed
