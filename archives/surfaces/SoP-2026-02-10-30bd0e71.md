...
1. Commit Message: DP-OPS-0042 agent system certification and harvester hardening
2. Create Pull Request (Title): DP-OPS-0042 Agent System Certification and Harvester Hardening
...
4. Confirm Merge (Commit Message): Enforce agent certification gates and harden role emergence harvesting logic
5. Confirm Merge (Extended Description):
