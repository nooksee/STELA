...
Steps:
0. **PRECONDITIONS**: Confirm intent carries `ADDENDUM REQUIRED` with a parseable base DP ID (DP-OPS-NNNN) and one-line blocker. If missing or malformed: **STOP** and request a correctly assembled foreman bundle.
