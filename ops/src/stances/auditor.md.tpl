...
Steps:
0. **PRECONDITIONS**: If bundle artifact, bundle manifest, or <DP_ID>-RESULTS.md is missing: **STOP**.
...
3. **RECEIPTS**: Confirm the RESULTS receipt at `storage/handoff/<DP_ID>-RESULTS.md` was generated by `ops/bin/certify` (tool-generated artifact - manually authored receipts are a hard FAIL).
