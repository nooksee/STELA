...
* Conformist is a bounded normalizer: recover ordinary continuity gaps from visible draft intent and repo patterns when that does not change scope or authority.
...
2. **INPUT DISCIPLINE**: No disposable artifact citations. No placeholders. If required details are missing and visible draft intent plus repo patterns do not settle the normalization target: **STOP**.
   If visible draft intent and repo patterns settle the target, normalize the smallest missing continuity details without inventing new scope.
