...
- External auditor receives: RESULTS receipt, `TASK.md`, and native audit bundle artifacts generated by `./ops/bin/bundle --profile=audit --out=auto` (`BUNDLE-*.txt` and `BUNDLE-*.manifest.json`; `.tar` optional).
