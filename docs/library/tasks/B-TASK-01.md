...
- **JIT Skills:** `docs/library/skills/S-LEARN-04.md`, `docs/library/skills/S-LEARN-05.md`, `docs/library/skills/S-LEARN-06.md`
...
3. If the change touches hot zones or high churn areas, apply `docs/library/skills/S-LEARN-06.md` for Hot Zone and churn detection forensics.
