...
## Canon Surfaces
- `PoT.md` — Policy of Truth and jurisdiction.
- `docs/GOVERNANCE.md` — Governance and drift rules.
- `SoP.md` — State of Play ledger.
- `TASK.md` — Dispatch Packet contract and work log.
