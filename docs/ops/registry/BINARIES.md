...
| OPS-BIN-11 | Certifier | ops/bin/certify | Spec: `docs/ops/specs/binaries/certify.md`. Runs integrity and receipt verification gates, then renders and validates DP RESULTS artifacts. |
