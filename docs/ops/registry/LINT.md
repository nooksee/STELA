...
| LINT-11 | RESULTS Lint | tools/lint/results.sh | Spec: `docs/ops/specs/tools/lint/results.md`. Verifies certification RESULTS schema, template hash parity, git hash parity, and Closing Block completeness; no-arg mode auto-targets the active branch packet receipt and `--all` enables full historical scans. |
