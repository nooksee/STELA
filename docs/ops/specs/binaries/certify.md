...
Phase and long-pole summaries are observational only. They do not alter pass/fail semantics. Replay order and lane selection are controlled by `ops/lib/manifests/VERIFY.md` plus the certify-generated changed-path file.
