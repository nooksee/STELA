...
- Ops canon: `ops/` (ICL/OCL doctrine, protocols, contracts, templates, ICL Continuity Core under `ops/init/icl/`).
...
- `ops/` - ICL/OCL canon (protocols, contracts, templates, ICL Continuity Core); non-runtime.
