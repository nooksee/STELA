...
* **Secondary lanes:** `addenda/addendum` (intervention), `conform/conformist` (normalization), `execution-decision` (disposable/manual) — bounded sidepaths, not replacements for RESULTS or audit truth.
